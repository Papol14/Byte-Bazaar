    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <section className="mb-8">
          <p className="mb-4">
            At Byte Bazaar, we're passionate about empowering individuals on
            their journey to digital excellence. Founded with the vision of
            making premium digital education accessible to everyone, we've
            curated a carefully selected collection of transformative learning
            resources, from comprehensive AI courses to expert-crafted e-books.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            ...
            by providing high-quality digital products that help you master new
