const About: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Welcome to Byte Bazaar</h1>

      <section className="mb-8">
        <p className="mb-4">
          At Byte Bazaar, we're passionate about empowering individuals on their
          journey to digital excellence. Founded with the vision of making
          premium digital education accessible to everyone, we've curated a
          carefully selected collection of transformative learning resources,
          from comprehensive AI courses to expert-crafted e-books.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          We believe that knowledge should be both accessible and actionable.
          Our mission is to bridge the gap between aspiration and achievement by
          providing high-quality digital products that help you master new
          skills, advance your career, and unlock your full potential in the
          digital age.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 mb-4">
          <li>
            Professional Freelancing Guides: Launch and grow your freelancing
            career with proven strategies and insider insights
          </li>
          <li>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          Beyond being just a marketplace, Byte Bazaar is a community of
      ...
      <section className="mb-8">
        <p className="mb-4">
          ...
          careers through our carefully curated digital resources. At Byte
          Bazaar, your success is our priority.
        </p>
        <p className="font-semibold">
          Ready to elevate your skills? Start exploring our collection today.
        </p>
      </section>
    </div>
  );
